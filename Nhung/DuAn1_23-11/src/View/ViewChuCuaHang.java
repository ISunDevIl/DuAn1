...
public class ViewChuCuaHang extends javax.swing.JFrame {
    ...
    public ViewChuCuaHang() {
        ...
        String input = JOptionPane.showInputDialog("nhap so luong");
    ...
    private void themgh() {
        ...
        String idhd = servicehd.findIDHD(tblhddshd.getValueAt(index, 1).toString()).getId();
        String input = JOptionPane.showInputDialog("Nhập số lượng");
        
        float dongia = (float) tblhddssp.getValueAt(i, 2);
        String magg = ggservice.findIDSP(idspct).getGiaTri().toString();
        float thanhtien = dongia - magg;
    ...
    public void loadGiohang(String a) {
        String sql = "Select IDHD,IDSPCT,SoLuong,DonGia,ThanhTien,MaGG FROM HoaDonChiTiet Where IDSPCT = ?";
        try {
            ...
            while (rs.next()) {
                ...
                String idspct = rs.getString(3);
                int soluong = rs.getInt(4);
                Float dongia = rs.getFloat(5);
                float thanhien = rs.getFloat(6);
                String magg = rs.getString(7);

                HoaDonChiTiet d = new HoaDonChiTiet(id, idhd, idspct, soluong, dongia, thanhien, magg);
                lsthdct.add(d);
            }
        ...
        for (HoaDonChiTiet x : lsthdct) {
            ...
            dtm.addRow(new Object[]{
                hdctservice.findIDSP(x.getIdspct()).getMasp(), hdctservice.findIDSP(x.getIdspct()).getTensp(), x.getSoLuong(),
                x.getDongia(), hdctservice.findMaGG(x.getMagg()).getGiatri(), x.getDongia() - hdctservice.findMaGG(x.getMagg()).getGiatri()
            });
        }
    ...
    public void LoadDataHD() {
        ...
        for (HoaDon hd : servicehd.getAllHoaDon()) {
            ...
            dtm.addRow(new Object[]{
                loadSTT(), hd.getMaHD(), hd.getMakh(), hd.getNgaytao(), trangthai
            });
        }
    }
    ...
    public void LoadDataHDSP() {
        ...
        dtm.setRowCount(0);
        for (SanPhamChiTiet sp : servicehd.getAllSanPham()) {
            dtm.addRow(new Object[]{
                servicehd.findIDSP(sp.getIdsp()).getMaSP(), servicehd.findIDSP(sp.getIdsp()).getTenSP(), sp.getGia(),
    ...
    private void initComponents() {
        ...
        jpthongkeLayout.setVerticalGroup(
            ...
            .addGroup(jpthongkeLayout.createSequentialGroup()
                ...
                .addGroup(jpthongkeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel21, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                    .addComponent(jPanel20, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                    .addComponent(jPanel23, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                    .addComponent(jPanel22, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE))
                .addGap(18, 18, 18)
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpdoimk, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1006, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpkhuyenmai, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1006, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpsanpham, javax.swing.GroupLayout.DEFAULT_SIZE, 1006, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpthongke, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1006, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpnhanvien, javax.swing.GroupLayout.DEFAULT_SIZE, 1006, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpkhachhang, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1006, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jplichsu, javax.swing.GroupLayout.DEFAULT_SIZE, 1006, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpthanhtoan, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1006, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGap(0, 654, Short.MAX_VALUE)
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpdoimk, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 694, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpkhuyenmai, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 694, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpsanpham, javax.swing.GroupLayout.DEFAULT_SIZE, 694, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpthongke, javax.swing.GroupLayout.DEFAULT_SIZE, 694, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpnhanvien, javax.swing.GroupLayout.DEFAULT_SIZE, 694, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpkhachhang, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 694, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jplichsu, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 694, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jpthanhtoan, javax.swing.GroupLayout.DEFAULT_SIZE, 694, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jphoadon, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel5Layout.createSequentialGroup()
