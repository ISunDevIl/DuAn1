...
public class SanPhamChiTiet {
    ...
    public SanPhamChiTiet(String id, String idsp, String idcl, String idpl, String idth, String idxx, String idms, String kichThuoc, Float khoiLuong, Integer soLuong, Float gia, String moTa, String anh, Byte trangThai) {
        this.id = id;
        this.idsp = idsp;
        this.idcl = idcl;
        this.idpl = idpl;
