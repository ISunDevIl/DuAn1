...
private static SanPham sp;
    ...
    public SanPhamChiTiet readFormSPCT(){
        ...
        spct.setIdpl(pls.findidPL(cbophanloai.getSelectedItem().toString()).getTen());
        spct.setIdms(mss.findidMS(cbomausac.getSelectedItem().toString()).getTen());
        spct.setIdcl(cls.findidCL(cbochatlieu.getSelectedItem().toString()).getTen());
        spct.setIdth(ths.findidTH(cbothuonghieu.getSelectedItem().toString()).getTen());
        spct.setIdxx(xxs.findidXX(cboxuatxu.getSelectedItem().toString()).getTen());
